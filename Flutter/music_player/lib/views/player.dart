          ...
          children: [
            ...
            Expanded(child: Container(
              ...
              child: Obx(
                  () => Column(
                  children: [
                  Text(data[controller.playIndex.value].title.toString(), style: ourStyle(color: bgDarkColor, family: bold, size: 24),),
                  const SizedBox(height: 12,),
                  Text(data[controller.playIndex.value].artist.toString(), style: ourStyle(color: bgDarkColor, family: regular, size: 20),),
                  const SizedBox(height: 12,),
                  Obx(
                    ()=> Row(children: [
